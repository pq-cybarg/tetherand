...
// Tetherand local patch: digest 0.11 removed the
// `digest::crypto_common` re-export — `BlockSizeUser` now lives in
// the standalone `crypto-common` crate. Importing directly.
