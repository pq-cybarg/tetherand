...
public class P1_Affine {
  ...
  public BLST_ERROR core_verify(P2_Affine pk, boolean hash_or_encode, byte[] msg, String DST) {
    return BLST_ERROR.swigToEnum(blstJNI.P1_Affine_core_verify__SWIG_1(swigCPtr, P2_Affine.getCPtr(pk), hash_or_encode, msg, DST));
  }

  public BLST_ERROR core_verify(P2_Affine pk, boolean hash_or_encode, byte[] msg) {
    return BLST_ERROR.swigToEnum(blstJNI.P1_Affine_core_verify__SWIG_2(swigCPtr, P2_Affine.getCPtr(pk), hash_or_encode, msg));
  }
