...
public class SecretKey {
  ...
  public void keygen_v4_5(byte[] IKM, byte[] salt, String info) {
    blstJNI.SecretKey_keygen_v4_5__SWIG_0(swigCPtr, IKM, salt, info);
  }

  public void keygen_v4_5(byte[] IKM, byte[] salt) {
    blstJNI.SecretKey_keygen_v4_5__SWIG_1(swigCPtr, IKM, salt);
  }

  public void keygen_v5(byte[] IKM, byte[] salt, String info) {
    blstJNI.SecretKey_keygen_v5__SWIG_0(swigCPtr, IKM, salt, info);
  }

  public void keygen_v5(byte[] IKM, byte[] salt) {
    blstJNI.SecretKey_keygen_v5__SWIG_1(swigCPtr, IKM, salt);
  }
