...
public class Pairing {
  ...
  public BLST_ERROR aggregate(P1_Affine pk, P2_Affine sig, byte[] msg) {
    return BLST_ERROR.swigToEnum(blstJNI.Pairing_aggregate__SWIG_1(swigCPtr, P1_Affine.getCPtr(pk), P2_Affine.getCPtr(sig), msg));
  }

  public BLST_ERROR aggregate(P2_Affine pk, P1_Affine sig, byte[] msg, byte[] aug) {
    return BLST_ERROR.swigToEnum(blstJNI.Pairing_aggregate__SWIG_2(swigCPtr, P2_Affine.getCPtr(pk), P1_Affine.getCPtr(sig), msg, aug));
  }

  public BLST_ERROR aggregate(P2_Affine pk, P1_Affine sig, byte[] msg) {
    return BLST_ERROR.swigToEnum(blstJNI.Pairing_aggregate__SWIG_3(swigCPtr, P2_Affine.getCPtr(pk), P1_Affine.getCPtr(sig), msg));
  }
  ...
  public BLST_ERROR mul_n_aggregate(P1_Affine pk, P2_Affine sig, java.math.BigInteger scalar, byte[] msg) {
    return BLST_ERROR.swigToEnum(blstJNI.Pairing_mul_n_aggregate__SWIG_1(swigCPtr, P1_Affine.getCPtr(pk), P2_Affine.getCPtr(sig), scalar.toByteArray(), msg));
  }

  public BLST_ERROR mul_n_aggregate(P2_Affine pk, P1_Affine sig, java.math.BigInteger scalar, byte[] msg, byte[] aug) {
    return BLST_ERROR.swigToEnum(blstJNI.Pairing_mul_n_aggregate__SWIG_2(swigCPtr, P2_Affine.getCPtr(pk), P1_Affine.getCPtr(sig), scalar.toByteArray(), msg, aug));
  }

  public BLST_ERROR mul_n_aggregate(P2_Affine pk, P1_Affine sig, java.math.BigInteger scalar, byte[] msg) {
    return BLST_ERROR.swigToEnum(blstJNI.Pairing_mul_n_aggregate__SWIG_3(swigCPtr, P2_Affine.getCPtr(pk), P1_Affine.getCPtr(sig), scalar.toByteArray(), msg));
  }
