...
public class TetherandService extends VpnService {

    public static final boolean VERBOSE = false;

    private static final String ACTION_START_VPN = "dev.tetherand.app.START_VPN";
    private static final String ACTION_CLOSE_VPN = "dev.tetherand.app.CLOSE_VPN";
    private static final String EXTRA_VPN_CONFIGURATION = "vpnConfiguration";

    private static final String TAG = TetherandService.class.getSimpleName();
    ...
    public static void start(Context context, VpnConfiguration config) {
        Intent intent = new Intent(context, TetherandService.class);
        intent.setAction(ACTION_START_VPN);
        intent.putExtra(TetherandService.EXTRA_VPN_CONFIGURATION, config);
    ...
    private static final class RelayTunnelConnectionStateHandler extends Handler {
        ...
        private final TetherandService vpnService;

        private RelayTunnelConnectionStateHandler(TetherandService vpnService) {
